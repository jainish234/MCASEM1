...
2.Find the students who were enrolled before January 1, 2022.
    ...
    SELECT * FROM Students WHERE enrollment_date < '1-jan-2022';
    OP:

       STUDENT_ID     STUDENT_NAME    ENROLLMENT_DATE    COURSE_ID
    _____________ ________________ __________________ ____________
            101     John Smith       15-09-22               201
            102     Mary Johnson     20-08-22               202
            103     David Wilson     10-10-22               203
            104     Jessica Brown    05-07-22               204
            105     Emily Davis      30-11-22               205
            106     Daniel Miller    12-06-22               206
            107     Olivia Harris    25-12-22               207
            108     Liam Martinez    08-05-22               208
            109     Ava Jones        18-04-22               209
            110     Noah Anderson    02-03-22               210
...
6. Retrieve the students with enrollment dates in the year 2022.

    SELECT * FROM Students WHERE enrollment_date LIKE '2022%';